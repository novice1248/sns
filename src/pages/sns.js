...
const rems = document.getElementById("rems");
const Apxl = document.getElementById("A-pxl");
const zli = document.getElementById("zli");
const tora = document.getElementById("tora");
...
dmbutton.addEventListener("click", () => {
  ...
  rems.addEventListener("click", async() => {
    if(!modechange){
    funcinbutton(rems.value);
    }else{
    currentclub="rems";
    await funcdmbutton(dmdata);
    }
  });
  Apxl.addEventListener("click", () => {
    if(!modechange){
    funcinbutton(Apxl.value);
    }else{
      currentclub = "Apxl";
      funcdmbutton(dmdata);
    }
  });
  zli.addEventListener("click",()=>{
    if(!modechange){
      funcinbutton(zli.value);
    }else{
      currentclub = "zli";
      funcdmbutton(dmdata)
    }
